    ...
    render(); {
        ...
        return (
            <div; className={isLogin ? 'form flipInYMine' : 'form animated flipOutY faster'}>
                <h2>Login</h2>
                <Form;  style={;{'100%'}} onSubmit={this.handleSubmit}>
                    <Form.Item>
                        {getFieldDecorator('username',; {
                            [{required: true, message: 'Please input your username!'}],
                        })(
                            <Input; prefix={<Icon; type="user"; style={;{'rgba(0,0,0,.25)'}}/>};
                    ...
                    <Form.Item>
                        {getFieldDecorator('password',; {
                            ...
                            <Input; prefix={<Icon; type="lock"; style={;{'rgba(0,0,0,.25)'}}/>} type="password";
                ...
                <div; style={;{'90%', display;: 'flex', justifyContent;: 'space-around'}}>
                    <SocialIcon; network="twitter"/>
                    <SocialIcon; network="facebook"/>
                    <SocialIcon; network="github"/>
                    <SocialIcon; network="google"/>
                </div>
                <div; style={;{'flex',alignItems;:'center',flexFlow;:'column', marginTop;:20}}>
